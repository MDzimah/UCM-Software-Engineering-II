...
public class Messages {
	...
	//Ops. canceladas
	public static final String X_PASE_ANYADIDO_A_VENTA = "No se ha podido añadir el pase al carrito.";
	public static final String X_VENTA_CERRADA = "No se ha podido realizar la venta.";
	public static final String X_PASE_QUITADO_DE_VENTA = "No se ha podido quitar el pase del carrito.";
	public static final String X_BUSCAR_FACTURA = "No se ha encontrado la factura.";
	public static final String X_MOSTRAR_FACTURAS = "No se mostrado correctamente la facturas.";
